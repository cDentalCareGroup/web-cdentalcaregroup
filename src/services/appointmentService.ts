...
export const appointmentService = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    extendAppointment: builder.mutation<AppointmentDetail, any>({
      query: (data) => ({
        url: '/appointment/extend',
        method: "POST",
        body: { ...data }
      }),
      transformResponse: (response: { data: AppointmentDetail }, meta, arg) => response.data,
    }),
    registerAppointmentPatient: builder.mutation<AppointmentDetail, any>({
      query: (data) => ({
        url: '/appointment/register/patient',
        method: "POST",
        body: { ...data }
      }),
      transformResponse: (response: { data: AppointmentDetail }, meta, arg) => response.data,
